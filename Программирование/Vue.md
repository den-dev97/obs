...
Для дополнительной информации можно почитать:

- [Lifecycle Hooks в Vue 2](https://vuejs.org/v2/guide/instance.html#Lifecycle-Diagram)
- [Lifecycle Hooks в Vue 3](https://v3.vuejs.org/guide/composition-api-lifecycle-hooks.html#lifecycle-hooks)